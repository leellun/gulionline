...
import com.newland.order.mapper.OrderMapper;
import com.newland.order.mapper.PayLogMapper;
import com.newland.order.service.IOrderService;
import com.newland.order.util.OrderNoUtils;
...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, Order> implements IOrderService {
    ...
    public String saveOrder(String courseId, String memberId) {
        ...
        order.setCourseId(Long.valueOf(courseId));
    ...
    public void updateOrderStatus(Map<String, String> notifyMap) {
        ...
        //更新课程销量
        eduCourseService.updateBuyCountById(String.valueOf(order.getCourseId()));
    }
