/*
 ...
 Source Schema         : guili_edu

 Target Server Type    : MySQL
 Target Server Version : 80019
 File Encoding         : 65001

 Date: 30/08/2022 22:49:15
*/
...
CREATE TABLE `acl_permission`  (
  ...
  `pid` bigint(0) NULL DEFAULT NULL COMMENT '所属上级',
  `name` varchar(37) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '名称',
  `type` tinyint(1) NULL DEFAULT NULL COMMENT '类型(1:菜单,2:按钮)',
  `permission_value` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '权限值',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'Permission对象' ROW_FORMAT = Dynamic;
...
CREATE TABLE `acl_role`  (
  ...
  `role_code` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '角色编码',
  `remark` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '备注',
  `is_deleted` tinyint(1) NOT NULL DEFAULT 0 COMMENT '逻辑删除 1（true）已删除， 0（false）未删除',
  `gmt_create` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `gmt_modified` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'Role对象' ROW_FORMAT = Dynamic;
...
CREATE TABLE `acl_user`  (
  `id` bigint(0) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '会员id',
  `username` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '微信openid',
  `password` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '密码',
  `nick_name` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '昵称',
  `salt` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '用户头像',
...
CREATE TABLE `acl_user_role`  (
  ...
  `gmt_modified` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'UserRole对象' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cms_ad`  (
  ...
  `image_url` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '图片地址',
  `color` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '背景颜色',
  `link_url` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '链接地址',
...
-- Records of cms_ad
-- ----------------------------
INSERT INTO `cms_ad` VALUES (1564619458321330177, 'sdfsdfsdfsdf', 1564610698379014100, NULL, NULL, NULL, 1);
...
-- ----------------------------
INSERT INTO `cms_ad_type` VALUES (1564610698379014146, 'sdfsdf');
...
INSERT INTO `edu_chapter` VALUES ('1564619539242045442', '1237934331175505922', 'sdrrsfsdfsdf', 1, '2022-08-30 22:22:22', '2022-08-30 22:22:22');
...
CREATE TABLE `edu_comment`  (
  ...
  `nickname` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '会员昵称',
  `avatar` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '会员头像',
...
-- ----------------------------
INSERT INTO `edu_course` VALUES ('1235102212250763265', '1234056168213590018', '1234359260595417090', '1234359260788355074', 'Spring Boot视频教程（上）核心技术篇', 160.0000, 160, 'https://grain-online-education.oss-cn-shenzhen.aliyuncs.com/cover/2020/03/12/7422533c-6712-4e91-912a-bdcd36c45971.jpg', 0, 15, 1, 'Normal', '2020-03-04 07:18:09', '2022-08-30 21:16:34');
...
INSERT INTO `edu_course` VALUES ('1237931293408890881', '3', '1234359260838686721', '1234359260893212673', 'MySQL核心技术', 118.0000, 190, 'https://grain-online-education.oss-cn-shenzhen.aliyuncs.com/cover/2020/03/12/7eb029a1-556d-4464-91b3-77d3946657d3.jpg', 0, 2, 1, 'Normal', '2020-03-12 02:39:55', '2022-08-30 20:57:58');
...
INSERT INTO `edu_course` VALUES ('1237934331175505922', '4', '1234359260595417090', '1237933857185599490', 'MyBatis', 118.0000, 90, 'https://grain-online-education.oss-cn-shenzhen.aliyuncs.com/cover/2020/03/12/c40d0add-a6ea-40d2-a824-bfa99064334d.jpg', 0, 0, 1, 'Normal', '2020-03-12 02:51:59', '2022-08-30 22:22:26');
INSERT INTO `edu_course` VALUES ('1564619726505136129', '1', '1234359260217929729', '1234359260389896194', 'sdfsdf', 10.0000, 1, '', 0, 0, 1, 'Normal', '2022-08-30 22:23:07', '2022-08-30 22:23:10');
...
INSERT INTO `edu_course_description` VALUES ('1564619726505136129', '<p>sdfsdfsdfs</p>', '2022-08-30 22:23:07', '2022-08-30 22:23:07');
...
CREATE TABLE `edu_video`  (
  ...
  `is_free` tinyint(0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否可以试听：0免费 1收费',
...
CREATE TABLE `statistics_daily`  (
  ...
  `register_num` int(0) NOT NULL COMMENT '注册人数',
...
CREATE TABLE `t_order`  (
  `id` bigint(0) UNSIGNED NOT NULL,
  `order_no` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '订单号',
  `course_id` bigint(0) NULL DEFAULT NULL COMMENT '课程id',
  `course_title` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '课程名称',
  `course_cover` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '课程封面',
  `teacher_name` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '讲师名称',
  `member_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '会员id',
  `nickname` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '会员昵称',
  ...
  `pay_type` int(0) NULL DEFAULT NULL COMMENT '支付类型（1：微信 2：支付宝）',
  `status` int(0) NULL DEFAULT NULL COMMENT '订单状态（0：未支付 1：已支付）',
  `is_deleted` tinyint(1) NOT NULL DEFAULT 0 COMMENT '逻辑删除 1（true）已删除， 0（false）未删除',
  `gmt_create` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `gmt_modified` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of t_order
-- ----------------------------
INSERT INTO `t_order` VALUES (1564601117686988802, '20220830210906412', 1237931293408890881, 'MySQL核心技术', 'https://grain-online-education.oss-cn-shenzhen.aliyuncs.com/cover/2020/03/12/7eb029a1-556d-4464-91b3-77d3946657d3.jpg', '韩老师', '1564592828668444674', '海伦', '18683446911', 11800.00, 1, 0, 0, '2022-08-30 21:09:10', '2022-08-30 21:09:10');
INSERT INTO `t_order` VALUES (1564602997704065026, '20220830211638721', 1235102212250763265, 'Spring Boot视频教程（上）核心技术篇', 'https://grain-online-education.oss-cn-shenzhen.aliyuncs.com/cover/2020/03/12/7422533c-6712-4e91-912a-bdcd36c45971.jpg', '缪老师', '1564592828668444674', '海伦', '18683446911', 16000.00, 1, 0, 0, '2022-08-30 21:16:38', '2022-08-30 21:16:38');
...
CREATE TABLE `t_pay_log`  (
  ...
  `total_fee` decimal(10, 2) NULL DEFAULT NULL COMMENT '订单金额（分）',
  `transaction_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '交易流水号',
  `trade_state` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '交易状态',
  `pay_type` int(0) NULL DEFAULT NULL COMMENT '支付类型（1：微信 2：支付宝）',
  `attr` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '其他属性',
  `is_deleted` tinyint(1) NOT NULL DEFAULT 0 COMMENT '逻辑删除 1（true）已删除， 0（false）未删除',
  `gmt_create` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `gmt_modified` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `ucenter_member` VALUES ('1564592828668444674', NULL, '18683446911', 'e10adc3949ba59abbe56e057f20f883e', '海伦', NULL, NULL, 'https://guli-file-191125.oss-cn-beijing.aliyuncs.com/avatar/default.jpg', NULL, 0, 0, '2022-08-30 20:36:14', '2022-08-30 20:36:14');
